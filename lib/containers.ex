defmodule Kogia.Containers do
  ...
  * `2`: Delete
  ...
  def list(client, filters \\ nil, params)

  def list(client, filters, params) do
    params = URI.encode_query(params)
    filters = if filters, do: "&filters=" <> Poison.encode!(filters), else: ""
  ...
  * `noOverwriteDirNonDir` - If “1”, “true”, or “True” then it will be an
  ...
  def put_archive(container, params, data, client, options) when is_map(container),
    do: put_archive(container["Id"], params, data, client, options)
